...
export default function StorefrontLayout({
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans antialiased">
        ...
        {itemCount > 0 && (
          ...
          >
            <Link href={`${base}/order`}>
              <motion.div
                whileTap={{ scale: 0.9 }}
                className="relative w-14 h-14 rounded-full bg-indigo-600 shadow-lg shadow-indigo-500/30 flex items-center justify-center text-white"
              >
      ...
      {/* Bottom navigation */}
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/80 backdrop-blur-xl border-t border-gray-100 md:hidden">
